    ...
    ui.zCanvas = pkg.zCanvas = Class(pkg.HtmlCanvas, [
        ...
        function $prototype() {
            ...
            this.$pointerEntered = function(e) {
                ...
                if (d !== o) {
                    ...
                    if (o != null) {
                        ...
                        ui.events.fireEvent("pointerExited", e.update(o, x, y));
                    }
            ...
            this.$pointerExited = function(e) {
                ...
                if (o != null) {
                    pkg.$pointerOwner[e.identifier] = null;
                    return ui.events.fireEvent("pointerExited", e.update(o,
            ...
            this.$pointerDragged = function(e){
                if (pkg.$pointerOwner[e.identifier] != null) {
                    return ui.events.fireEvent("pointerDragged", e.update(pkg.$pointerOwner[e.identifier],
                                                                           this.$toElementX(e.pageX, e.pageY),
                                                                           this.$toElementY(e.pageX, e.pageY)));
                }
            ...
            this.$pointerDragEnded = function(e) {
                if (pkg.$pointerOwner[e.identifier] != null) {
                    return ui.events.fireEvent("pointerDragEnded", e.update(pkg.$pointerOwner[e.identifier],
                                                                             this.$toElementX(e.pageX, e.pageY),
                                                                             this.$toElementY(e.pageX, e.pageY)));
                }
                return false;
            ...
            this.$pointerPressed = function(e) {
                ...
                if (d !== null && d.isEnabled === true) {
                    ...
                    if (ui.events.fireEvent("pointerPressed", e.update(d, x, y)) === true) {
                        delete pkg.$pointerPressedOwner[e.identifier];
                        return true;
                    }
                }
            ...
            this.relocated = function(px,py) {
                ...
                COMP_EVENT.px     = px;
                COMP_EVENT.py     = py;
                ui.events.fireEvent("compMoved", COMP_EVENT);
            };
            ...
            this.resized = function(pw,ph) {
                ...
                ui.events.fireEvent("compSized", COMP_EVENT);
