    ...
    pkg.WinLayerMix = zebkit.Interface([
            ...
            this.activate = function(c) {
                ...
                if (c !== this.activeWin) {
                    ...
                    if (c === null) {
                        ...
                        pkg.events.fireEvent("winActivated", WIN_EVENT.$fillWith(c, this, true, false));
        ...
        function kidAdded(index, constr, lw){
            ...
            if (lw.winType === "modal") {
                ...
                pkg.events.fireEvent("winOpened", WIN_EVENT.$fillWith(lw, this, false, true));
                this.activate(lw);
            } else {
                pkg.events.fireEvent("winOpened", WIN_EVENT.$fillWith(lw, this, false, true));
            }
        ...
        function kidRemoved(index, lw){
            ...
            pkg.events.fireEvent("winOpened", WIN_EVENT.$fillWith(lw, this, false, false));
